package com.project.scenepickbe.common.s3.service;
...
public class S3CommandService {
	 ...
	 */
	public S3ResponseDto.PresignedUrlToUploadResponse getPresignedUrlToUpload(
		String userId, S3Domain domain, S3RequestDto.PresignedUrlToUploadRequest request) {

		String keyName = createKeyName(domain, userId, request.getFileName());
		...
		return S3ResponseDto.PresignedUrlToUploadResponse.builder()
			.url(url)
			.keyName(keyName)
			.build();
	}
